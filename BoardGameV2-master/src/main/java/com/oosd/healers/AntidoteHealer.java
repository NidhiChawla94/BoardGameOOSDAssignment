...
* @version 1.0
* @classDesciption AntidoteHealer extends the healer class and perform healing action
*             
*/

@JsonIgnoreProperties(ignoreUnknown = true)
public class AntidoteHealer extends Healer{
	
	private static final Double HEALING_VOLUME = 100.00; // Declare the life volume of piece
